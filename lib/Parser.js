...
var Tokenizer_js_1 = __importDefault(require("./Tokenizer.js"));
...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.clearAttributes = function () {
        if (!this.attribs)
            return;
        this.attribs = "";
    };
     ...
     * @internal
     */
    Parser.prototype.getAttributes = function () {
        return (this.parseAttributes
            ? Attributes_js_1.Attributes.toJSON(this.attribs, this.options.lowerCaseAttributeNames)
            : this.attribs);
    };
    /** @internal */
    Parser.prototype.onattrib = function (start, endIndex) {
